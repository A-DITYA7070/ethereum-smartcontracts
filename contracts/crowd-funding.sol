...
contract CrowdFunding {
    ...
    enum CampaignState {Active,Successfull,Failed} CampaignState public state;
    ...
    function fund(uint256 _tierIndex) campaignOpen notPaused public payable {
    ...
    function withDraw() onlyOwner public{
        checkAndUpdateCampaignState();
        require(state == CampaignState.Successfull,"Campign not successfull");
    ...
    function removeTier(
        ...
        require(_index < tiers.length,"Tier doesnot exists");
